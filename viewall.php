...
echo "<th>Username</th><th>Name</th><th>Age</th><th>Gender</th><th>DateOfBirth</th><th>Designation</th><th>Department</th><th>EmailID</th><th>ContactNO</th>";

while($res=mysqli_fetch_array($result))
{
	echo "<tr>";
	echo "<td>".$res['Username']."</td><td>".$res['name']."</td><td>".$res['age']."</td><td>".$res['gender']."</td><td>".$res['DOB']."</td><td>".$res['designation']."</td><td>".$res['department']."</td><td>".$res['emailid']."</td><td>".$res['contactno']."</td>";
	echo "</tr>";
}
echo "</table>";
