...
while($res=mysqli_fetch_array($result))
{
	...
	$_SESSION['leaveid']=$l;
	echo "<tr>";
	echo "<td><a href=\"approval.php\">".$l."</a></td><td>".$res['userName']."</td><td>".$res['dateofrequest']."</td><td>".$res['leave_type']."</td><td>".$res['leave_from']."</td><td>".$res['leave_to']."</td><td>".$res['days']."</td><td>".$st."</td>";
	echo "</tr>";
	}
...
<br><br><br>
<font color="black"><p>/*Click on the LeaveID to select what to happen with the leave request*/</p></font>
</body>
</html>
